...
public class StudentController {
    ...
    @GetMapping
    public Result<PageBean<StudentClass>> list(@RequestParam(defaultValue = "1") Integer page,
                                               @RequestParam(defaultValue = "10") Integer pageSize,
                                               String name, Short highestDegree, Integer classesId, String studentNumber) {
